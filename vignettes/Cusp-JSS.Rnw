...
\Address{
	...
	URL: \url{http://raoul.socsci.uva.nl/}\\
}
...
\begin{figure}[tbp]
\begin{center}
  \hspace{0cm}\includegraphics[width=18cm,angle=0,,bb=0 0 702 702]{plaatjes/cusp-surface-R.pdf} \\ % journal layout preview
...
\begin{figure}[tbp]
\begin{center}
  \hspace{0cm}\includegraphics[width=16cm,angle=0,bb=0 0 584 590]{plaatjes/cuspdens-JSSv2.pdf} \\
...
\begin{figure*}[htbp]
\begin{center}
  \hspace{0cm}\includegraphics[width=16cm,angle=0,bb=0 0 675 621]{plaatjes/attudefitplot.pdf} \\ % journal layout preview
...
\begin{figure}[bdp]
\begin{center}
  \hspace{0cm}\includegraphics[width=14cm,angle=0,bb=0 0 540 520]{plaatjes/olivabifurcationplot.pdf} \\ % journal layout preview
...
\begin{figure}[tbdp]
\begin{center}
  \hspace{0cm}\includegraphics[width=16cm,angle=0,bb=0 0 540 540]{plaatjes/oliva3Dplot-new.pdf} \\ % journal layout preview
